...
testcases = 
  [
    ...
    -- ex7_8 simple arith (no var)
    ("simple_add.let7_8", Just "46"),
    ("simple_mul.let7_8", Just "30"),
    ("simple_div.let7_8", Just "16"),

    -- ex7_8 simple arith (var)
    ("simple_add_var.let7_8", Just "5"),
    ("simple_mul_var.let7_8", Just "6"),
    ("simple_div_var.let7_8", Just "3"),

    -- comparisons
    ("test_equal.let7_8", Just "True"),
    ("test_greater.let7_8", Just "False"),
